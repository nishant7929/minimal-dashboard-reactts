...
const _mock = {
  ...
  image: {
    cover: (index: number) =>
      `${HOST_API_KEY}/assets/images/covers/cover_${index + 1}.jpg`,
    product: (index: number) =>
      `${HOST_API_KEY}/assets/images/products/product_${index + 1}.jpg`,
    avatar: (index: number) =>
      `${HOST_API_KEY}/assets/images/avatars/avatar_${index + 1}.jpg`,
  },
};
